...
let k = JSON.parse(localStorage.ls);
// let newN = "";
// let newM = "";
// let newP = "";
// let newC = "";
for (let j of k) {
    ...
    //     }
    // }
    // let newProduct = new AddProd(newN, newM, newP, newC);
    let newProduct = new AddProd(j["name"], j["email"],j["price"], j["color"]);
...
function SellProd() {
    ...
    function logOut() {
        location.href = "index.html"; // exit from profile.. back to 1st page.
    }
    // <<---------3rd page---------->>
